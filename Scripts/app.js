...
var cpuSpeed = 6; //The speed of the CPU paddle; the faster it is the harder the game// Variables
...
function Main() {
    ...
    SoundJS.FlashPlugin.BASE_PATH = "./Assets/Sounds/";
    ...
    manifest = [
        ...
        { src: "./Assets/Images/main.png", id: "main" },
        { src: "./Assets/Images/startB.png", id: "startB" },
        { src: "./Assets/Images/creditsB.png", id: "creditsB" },
        { src: "./Assets/Images/credits.png", id: "credits" },
        { src: "./Assets/Images/paddle.png", id: "cpu" },
        { src: "./Assets/Images/paddle.png", id: "player" },
        { src: "./Assets/Images/ball.png", id: "ball" },
        { src: "./Assets/Images/win.png", id: "win" },
        { src: "./Assets/Images/lose.png", id: "lose" },
        { src: "./Assets/Sounds/playerScore.mp3|playerScore.ogg", id: "playerScore" },
        { src: "./Assets/Sounds/enemyScore.mp3|enemyScore.ogg", id: "enemyScore" },
        { src: "./Assets/Sounds/hit.mp3|hit.ogg", id: "hit" },
        { src: "./Assets/Sounds/wall.mp3|wall.ogg", id: "wall" }
    ];
